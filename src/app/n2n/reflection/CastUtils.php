...
class CastUtils {
	...
	public static function stringOrNull($arg) {
		...
		throw new TypeCastException('Can not cast ' . ReflectionUtils::getTypeInfo($arg) . ' to string: ' 
	...
	public static function intOrNull($arg) {
		...
		throw new TypeCastException('Can not cast ' . ReflectionUtils::getTypeInfo($arg) . ' to int.');
	}
}
